    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('therapist_email', models.EmailField(blank=True, max_length=254)),
                ('office_address', models.TextField(blank=True, max_length=800)),
                ('qualification', models.CharField(blank=True, max_length=200)),
                ('specialization_area', models.CharField(blank=True, max_length=400)),
